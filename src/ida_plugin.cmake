...
ELSEIF(APPLE)
  ...
  IF(${CMAKE_SYSTEM_PROCESSOR} STREQUAL "arm64")
    IF(${UNI64})
      TARGET_LINK_LIBRARIES(${target_name}    ${IDASDK_DIR}/lib/arm64_mac_clang_64${PRO}/libida.dylib -flto)
    ELSE()
      TARGET_LINK_LIBRARIES(${target_name}    ${IDASDK_DIR}/lib/arm64_mac_clang_32${PRO}/libida.dylib -flto)
      TARGET_LINK_LIBRARIES(${target_name}_64 ${IDASDK_DIR}/lib/arm64_mac_clang_64${PRO}/libida64.dylib -flto)
    ENDIF()
  ELSE()
    IF(${UNI64})
      TARGET_LINK_LIBRARIES(${target_name}    ${IDASDK_DIR}/lib/x64_mac_clang_64${PRO}/libida.dylib -flto)
    ELSE()
      TARGET_LINK_LIBRARIES(${target_name}    ${IDASDK_DIR}/lib/x64_mac_clang_32${PRO}/libida.dylib -flto)
      TARGET_LINK_LIBRARIES(${target_name}_64 ${IDASDK_DIR}/lib/x64_mac_clang_64${PRO}/libida64.dylib -flto)
    ENDIF()
  ENDIF()
