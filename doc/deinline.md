...
> - Files of inlines specific for dissected sample (e.g. specific for malware family) may be moved from Inlines Library folder to IDA work folder (where IDB file is stored) or any of it's subfolders.
