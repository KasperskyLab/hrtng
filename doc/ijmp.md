...
When indirect call has a few targets have been visited with *"Jump to indirect call (J)"* they are appered in [auto-comment](auto-cmt.md) above call statement. Double click or press 'Enter' on name/address to jump.
